"""Process and physically review the independently generated adulthood batch.
...
RAW = ROOT / "art/sources/adulthood"
NORMALIZED = RAW / "normalized"
PUBLIC = ROOT / "public/assets/art"
QA = ROOT / "art/qa/adulthood"
INVENTORY = json.loads((ROOT / "src/story/adulthood-art.json").read_text(encoding="utf-8"))
LIMIT = 8 * 1024 * 1024
...
def validate() -> None:
    ...
    assert len(entries) == 26 and len(INVENTORY["scenes"]) == 13
    ...
    print("Adulthood art passed: 26 sprites, 11 backgrounds, 2 CGs; dimensions, alpha, stature, alignment and per-file precache limit.")
...
def qa() -> None:
    ...
    scenes = Image.new("RGB", (1200, 250 * 5), "#eee9e0")
