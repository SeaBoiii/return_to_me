"""Process and physically review the independently generated umrah batch.
...
RAW = ROOT / "art/sources/umrah"
NORMALIZED = RAW / "normalized"
PUBLIC = ROOT / "public/assets/art"
QA = ROOT / "art/qa/umrah"
INVENTORY = json.loads((ROOT / "src/story/umrah-art.json").read_text(encoding="utf-8"))
LIMIT = 8 * 1024 * 1024
...
def validate() -> None:
    ...
    assert len(entries) == 16 and len(INVENTORY["scenes"]) == 10
    ...
    print("Umrah art passed: 16 sprites, 7 backgrounds, 3 CGs; dimensions, alpha, stature, alignment and per-file precache limit.")
